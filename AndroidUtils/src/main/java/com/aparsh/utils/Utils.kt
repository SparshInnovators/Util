...
public class Utils {
    ...
    companion object {
        ...
        suspend fun setData(dataStore: DataStore<Preferences>?, key: String, value: Boolean) {
        ...
        suspend fun setData(dataStore: DataStore<Preferences>?, key: String, value: String) {
        ...
        suspend fun setData(dataStore: DataStore<Preferences>?, key: String, value: Int) {
        ...
        suspend fun getData(dataStore: DataStore<Preferences>?, key: String, default: Int): Int? {
            val dataStoreKey = intPreferencesKey(key)
            val preferences = dataStore!!.data.first()
            return preferences[dataStoreKey]
        }
